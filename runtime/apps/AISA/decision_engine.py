...
class DecisionEngineConnexion(CaseHandlingDecisionEngine):
    ...
    def _decide(self, input: CaseHandlingDecisionInput) -> CaseHandlingDecisionOutput:
        if input.intention_id == "city_plots_for_apartment_blocks_and_terraced_houses":
            email = "asuntotonttitiedustelut@hel.fi"
        else:
            email = "tontti@hel.fi"
            # city_plots_for_detached_houses
            # complimentary_construction_for_housing_cooperative_plots
            # city_plots_for_sports_and_sporting_activities
            # city_plots_and_areas_for_purposes_other_than_construction
            # commercial_plots
            # control_of_plots_rented_by_the_city_and_management_of_vacant_plots
