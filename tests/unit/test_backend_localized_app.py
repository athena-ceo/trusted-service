...
class TestLocalizedAppFallback:
    ...
    def test_create_fallback_response_fr(self):
    ...
    def test_create_fallback_response_en(self):
    ...
    def test_create_fallback_response_error_message_contains_traceback(self):
...
class TestLocalizedAppAnalyzeRetry:
    ...
    def test_analyze_success_first_try(self, mock_sleep, mock_llm_config):
    ...
    @patch('time.sleep')
    def test_analyze_retry_on_error(self, mock_sleep, mock_llm_config):
    ...
    @patch('time.sleep')
    def test_analyze_returns_fallback_after_3_failures(self, mock_sleep, mock_llm_config):
    ...
    @patch('time.sleep')
    def test_analyze_retry_delay_2_seconds(self, mock_sleep, mock_llm_config):
    ...
    @patch('time.sleep')
    def test_analyze_different_exception_types(self, mock_sleep, mock_llm_config):
