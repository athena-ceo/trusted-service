...
from src.common.case_model import CaseField, CaseModel, OptionalListElement


class TestCaseField:
    """Tests pour CaseField."""

    def test_case_field_creation_valid(self) -> None:
    ...
    def test_case_field_intention_ids_string_conversion(self) -> None:
    ...
    def test_case_field_intention_ids_list_unchanged(self) -> None:
    ...
    def test_case_field_intention_ids_empty_string(self) -> None:
    ...
    def test_case_field_intention_ids_none(self) -> None:
    ...
    def test_case_field_with_allowed_values(self) -> None:
    ...
    def test_case_field_default_values(self) -> None:
...
class TestCaseModel:
    ...
    def test_case_model_creation(self, sample_case_field) -> None:
    ...
    def test_case_model_get_field_by_id(self, sample_case_field) -> None:
    ...
    def test_case_model_get_field_by_id_not_found(self, sample_case_field) -> None:
...
class TestOptionalListElement:
    ...
    def test_optional_list_element_creation(self) -> None:
    ...
    def test_optional_list_element_validation(self) -> None:
