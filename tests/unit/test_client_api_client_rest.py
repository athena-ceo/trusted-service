...
class TestApiClientRestGet:
    ...
    def test_get_simple(self, mock_get, client):
        """Test get() simple"""
        mock_response = Mock()
    ...
    @patch('src.client.api_client_rest.requests.get')
    def test_get_with_app_id(self, mock_get, client):
    ...
    @patch('src.client.api_client_rest.requests.get')
    def test_get_with_app_id_and_locale(self, mock_get, client):
    ...
    @patch('src.client.api_client_rest.requests.get')
    def test_get_error_status(self, mock_get, client):
...
class TestApiClientRestAnalyze:
    ...
    def test_analyze_success(self, mock_post, client):
    ...
    @patch('src.client.api_client_rest.requests.post')
    def test_analyze_with_field_values(self, mock_post, client):
    ...
    @patch('src.client.api_client_rest.requests.post')
    def test_analyze_error(self, mock_post, client):
...
class TestApiClientRestOtherMethods:
    ...
    def test_get_app_ids(self, mock_get, client):
        """Test get_app_ids()"""
    ...
    @patch('src.client.api_client_rest.ApiClientRest.get')
    def test_get_locales(self, mock_get, client):
        """Test get_locales()"""
    ...
    @patch('src.client.api_client_rest.ApiClientRest.get')
    def test_get_llm_config_ids(self, mock_get, client):
    ...
    @patch('src.client.api_client_rest.ApiClientRest.get')
    def test_get_decision_engine_config_ids(self, mock_get, client):
    ...
    @patch('src.client.api_client_rest.ApiClientRest.get')
    def test_get_app_name(self, mock_get, client):
        """Test get_app_name()"""
    ...
    @patch('src.client.api_client_rest.ApiClientRest.get')
    def test_get_app_description(self, mock_get, client):
    ...
    @patch('src.client.api_client_rest.ApiClientRest.get')
    def test_get_sample_message(self, mock_get, client):
    ...
    @patch('src.client.api_client_rest.ApiClientRest.get')
    def test_get_case_model(self, mock_get, client):
        """Test get_case_model()"""
    ...
    @patch('src.client.api_client_rest.ApiClientRest.get')
    def test_get_case_model_none(self, mock_get, client):
...
class TestApiClientRestReloadAndSave:
    ...
    @patch('src.client.api_client_rest.requests.post')
    def test_reload_apps_success(self, mock_post, client):
    ...
    @patch('src.client.api_client_rest.requests.post')
    def test_reload_apps_error(self, mock_post, client):
    ...
    @patch('src.client.api_client_rest.requests.post')
    def test_save_text_analysis_cache_success(self, mock_post, client):
    ...
    @patch('src.client.api_client_rest.requests.post')
    def test_save_text_analysis_cache_error(self, mock_post, client):
...
class TestApiClientRestHandleCase:
    ...
    @patch('src.client.api_client_rest.requests.post')
    def test_handle_case_success(self, mock_post, client):
    ...
    @patch('src.client.api_client_rest.requests.post')
    def test_handle_case_error(self, mock_post, client):
