...
class TestFrontendPages:
    ...
    def test_homepage_loads(self, page: Page, frontend_base_url: str) -> None:
    ...
    def test_accueil_etrangers_page_loads(
        self, page: Page, frontend_base_url: str
    ) -> None:
        ...
        assert (
            page.locator("input[name='nom'], input[id='nom']").count() > 0
        ), "Last name field should exist"

    def test_dsfr_styles_loaded(self, page: Page, frontend_base_url: str) -> None:
...
class TestFormFunctionality:
    ...
    def test_form_fields_visible(self, page: Page, frontend_base_url: str) -> None:
    ...
    def test_form_validation(self, page: Page, frontend_base_url: str) -> None:
...
class TestAPIIntegration:
    ...
    def test_api_proxy_works(self, page: Page, frontend_base_url: str) -> None:
...
class TestAccessibility:
    ...
    def test_page_has_proper_structure(
        self, page: Page, frontend_base_url: str
    ) -> None:
    ...
    def test_form_labels(self, page: Page, frontend_base_url: str) -> None:
...
class TestPerformance:
    ...
    def test_page_loads_quickly(self, page: Page, frontend_base_url: str) -> None:
    ...
    def test_no_console_errors(self, page: Page, frontend_base_url: str) -> None:
...
class TestResponsiveness:
    ...
    def test_mobile_viewport(self, page: Page, frontend_base_url: str) -> None:
    ...
    def test_tablet_viewport(self, page: Page, frontend_base_url: str) -> None:
