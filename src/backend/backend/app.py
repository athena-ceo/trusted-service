...
from src.common.logging import print_red, print_green, print_blue
...
class App(Api):
    ...
    def __init__(self, config_filename: str, server_configuration: ServerConfiguration, ):
        ...
        self.preprocessing = app_configuration.preprocessing

        self.llm_configs: dict[str, LlmConfig] = {llm_config.id: llm_config for llm_config in server_configuration.llm_configs}
    ...
    def get_llm_config_ids(self, app_id: str) -> list[str]:
        ...
        # return self.localized_apps[loc].get_llm_config_ids(app_id, loc)
    ...
    def analyze(self, app_id: str, loc: SupportedLocale, field_values: dict[str, Any], text: str, read_from_cache: bool, llm_config_id: str) -> dict[str, Any]:
        return self.localized_apps[loc].analyze(app_id, loc, field_values, text, read_from_cache, llm_config_id)
