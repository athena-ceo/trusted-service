...
class Connection:
    def __init__(
        ...
        self.auth = HTTPBasicAuth(
            username,
            password,
        )  # Initialize auth with self.username and self.password
        self.verbose = verbose

    def call_request(self, method: str, endpoint: str, **kwargs) -> dict:
        """Make a request to the specified API endpoint and forwarding the args to the original request function."""
