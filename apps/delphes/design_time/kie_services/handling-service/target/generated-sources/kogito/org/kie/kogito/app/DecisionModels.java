...
public class DecisionModels extends org.kie.kogito.dmn.AbstractDecisionModels {
    ...
    static {
        ...
        null, null, readResource(Application.class.getResourceAsStream("/DataTypes.dmn"), "UTF-8"), readResource(Application.class.getResourceAsStream("/SubModel.dmn"), "UTF-8"), readResource(Application.class.getResourceAsStream("/Migrations.dmn"), "UTF-8"));
    }
