 ...
 * under the License.
 */
package https_58_47_47kie_46org_47dmn_47__A8CA9047_45CF92_454F7E_458536_451C355FEC1656;
...
@Path("/DMN_69E35C34-98CE-4C26-B4BC-B8442D95F5F4")
public class DMN__69E35C34_4598CE_454C26_45B4BC_45B8442D95F5F4Resource {
    ...
    @org.eclipse.microprofile.openapi.annotations.parameters.RequestBody(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/DataTypes.json#/definitions/InputSet")), description = "DMN input")
    @org.eclipse.microprofile.openapi.annotations.responses.APIResponse(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/DataTypes.json#/definitions/OutputSet")), description = "DMN output")
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kie.org/dmn/_A8CA9047-CF92-4F7E-8536-1C355FEC1656", "DMN_69E35C34-98CE-4C26-B4BC-B8442D95F5F4");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateAll(DMNJSONUtils.ctx(decision, variables));
        KogitoDMNResult result = new KogitoDMNResult("https://kie.org/dmn/_A8CA9047-CF92-4F7E-8536-1C355FEC1656", "DMN_69E35C34-98CE-4C26-B4BC-B8442D95F5F4", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        try (InputStream is = this.getClass().getResourceAsStream(CodegenStringUtil.escapeIdentifier("DMN_69E35C34-98CE-4C26-B4BC-B8442D95F5F4") + ".dmn_nologic")) {
