 ...
 * under the License.
 */
package https_58_47_47kie_46apache_46org_47dmn_47__58D2E33E_455C5A_4540C8_4593C8_454EE88A0338CB;
...
public class UPPERResource {
    ...
    @org.eclipse.microprofile.openapi.annotations.parameters.RequestBody(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/SubModel.json#/definitions/InputSet")), description = "DMN input")
    @org.eclipse.microprofile.openapi.annotations.responses.APIResponse(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/SubModel.json#/definitions/OutputSet")), description = "DMN output")
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kie.apache.org/dmn/_58D2E33E-5C5A-40C8-93C8-4EE88A0338CB", "UPPER");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateAll(DMNJSONUtils.ctx(decision, variables));
        KogitoDMNResult result = new KogitoDMNResult("https://kie.apache.org/dmn/_58D2E33E-5C5A-40C8-93C8-4EE88A0338CB", "UPPER", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        try (InputStream is = this.getClass().getResourceAsStream(CodegenStringUtil.escapeIdentifier("UPPER") + ".dmn_nologic")) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    @org.eclipse.microprofile.openapi.annotations.parameters.RequestBody(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/SubModel.json#/definitions/InputSetDSUpperDS")), description = "DMN input")
    @org.eclipse.microprofile.openapi.annotations.responses.APIResponse(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/SubModel.json#/definitions/OutputSetDSUpperDS")), description = "DMN output")
    public Response decisionService__UpperDS(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kie.apache.org/dmn/_58D2E33E-5C5A-40C8-93C8-4EE88A0338CB", "UPPER");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateDecisionService(DMNJSONUtils.ctx(decision, variables, "UpperDS"), "UpperDS");
        KogitoDMNResult result = new KogitoDMNResult("https://kie.apache.org/dmn/_58D2E33E-5C5A-40C8-93C8-4EE88A0338CB", "UPPER", decisionResult);
        return enrichResponseHeaders(decisionResult, extractSingletonDSIfSucceded(result));
    }

    @POST
    @Path("/UpperDS/dmnresult")
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    @org.eclipse.microprofile.openapi.annotations.parameters.RequestBody(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/SubModel.json#/definitions/InputSetDSUpperDS")), description = "DMN input")
    public Response decisionService__UpperDS_dmnresult(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kie.apache.org/dmn/_58D2E33E-5C5A-40C8-93C8-4EE88A0338CB", "UPPER");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateDecisionService(DMNJSONUtils.ctx(decision, variables, "UpperDS"), "UpperDS");
        KogitoDMNResult result = new KogitoDMNResult("https://kie.apache.org/dmn/_58D2E33E-5C5A-40C8-93C8-4EE88A0338CB", "UPPER", decisionResult);
        return buildDMNResultResponse(result);
