...
public class Case {
	...
	public boolean isRefugie_ou_protege_subsidiaire() {
		return refugie_ou_protege_subsidiaire;
	}

	public void setRefugie_ou_protege_subsidiaire(boolean refugie_ou_protege_subsidiaire) {
