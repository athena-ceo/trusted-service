...
const translations: Record<Language, Record<string, string>> = {
    FR: {
        ...
        // Service title
        'service.title.': 'Les services de l\'État',
        ...
        // Footer
        'footer.home': 'DELPHES',
        'footer.description': 'Portail officiel des services de l\'État dans le département',
        ...
        'accueil.intro.aiProcessing.78': 'Votre demande est pré-traitée par un système d\'intelligence artificielle qui en analyse le contenu avant transmission à un agent de la Direction des Migrations de la préfecture des Yvelines. Si votre situation relève d\'une démarche déjà disponible en ligne sur un service public, vous serez automatiquement orienté vers cette procédure. La préfecture sera néanmoins informée de votre demande afin d\'en assurer le suivi.',
        'accueil.intro.aiProcessing.91': 'Votre demande est pré-traitée par un système d\'intelligence artificielle qui en analyse le contenu avant transmission à un agent de la Direction des Migrations de la préfecture de l\'Essonne. Si votre situation relève d\'une démarche déjà disponible en ligne sur un service public, vous serez automatiquement orienté vers cette procédure. La préfecture sera néanmoins informée de votre demande afin d\'en assurer le suivi.',
        'accueil.intro.aiProcessing.92': 'Votre demande est pré-traitée par un système d\'intelligence artificielle qui en analyse le contenu avant transmission à un agent de la Direction des Migrations de la préfecture des Hauts-de-Seine. Si votre situation relève d\'une démarche déjà disponible en ligne sur un service public, vous serez automatiquement orienté vers cette procédure. La préfecture sera néanmoins informée de votre demande afin d\'en assurer le suivi.',
        'accueil.intro.aiProcessing.94': 'Votre demande est pré-traitée par un système d\'intelligence artificielle qui en analyse le contenu avant transmission à un agent de la Direction des Migrations de la préfecture du Val-de-Marne. Si votre situation relève d\'une démarche déjà disponible en ligne sur un service public, vous serez automatiquement orienté vers cette procédure. La préfecture sera néanmoins informée de votre demande afin d\'en assurer le suivi.',
        'accueil.alert.info.title': 'Information importante',
        'accueil.alert.info.message': 'Pour toute information concernant le suivi de votre demande de titre de séjour, indiquez impérativement votre numéro étranger/AGDREF (à 10 chiffres) figurant sur votre titre si vous en avez un.',
        'accueil.alert.info.processingTime.78': 'En raison de la forte demande, l\'instruction des dossiers nécessite un certain temps. Inutile de renouveler votre demande afin de ne pas augmenter le travail des agents.',
        'accueil.alert.info.processingTime.91': 'En raison de la forte demande, l\'instruction des dossiers nécessite un certain temps. Inutile de renouveler votre demande afin de ne pas augmenter le travail des agents.',
        'accueil.alert.info.processingTime.92': 'En raison de la forte demande, l\'instruction des dossiers nécessite un certain temps. Inutile de renouveler votre demande afin de ne pas augmenter le travail des agents.',
        'accueil.alert.info.processingTime.94': 'En raison de la forte demande, l\'instruction des dossiers nécessite un certain temps. Inutile de renouveler votre demande afin de ne pas augmenter le travail des agents.',
        'accueil.alert.warning.78': 'Les données personnelles saisies dans ce formulaire ne sont pas conservées par le service d\’intelligence artificielle. Elles sont transmises directement et exclusivement à la préfecture des Yvelines pour le traitement de votre demande.',
        'accueil.alert.warning.91': 'Les données personnelles saisies dans ce formulaire ne sont pas conservées par le service d\’intelligence artificielle. Elles sont transmises directement et exclusivement à la préfecture de l\'Essonne pour le traitement de votre demande.',
        'accueil.alert.warning.92': 'Les données personnelles saisies dans ce formulaire ne sont pas conservées par le service d\’intelligence artificielle. Elles sont transmises directement et exclusivement à la préfecture des Hauts-de-Seine pour le traitement de votre demande.',
        'accueil.alert.warning.94': 'Les données personnelles saisies dans ce formulaire ne sont pas conservées par le service d\’intelligence artificielle. Elles sont transmises directement et exclusivement à la préfecture du Val-de-Marne pour le traitement de votre demande.',
        ...
        'analysis.form.cases': 'cas pouvant correspondre à votre demande.',
        'analysis.form.yourSelection': 'Veuillez sélectionner le cas qui s\'applique à votre situation ou bien revenir au formulaire et reformuler votre demande.',
        ...
        'analysis.form.fields.numero_dossier_ANEF': 'Numéro de dossier ANEF (19 chiffres)',
        ...
        'analysis.backToHome': 'Retour au formulaire',
        ...
        'handleCase.nextSteps.message': 'Veuillez suivre les instructions ci-dessus. En cas de besoin, un agent du service concerné vous contactera à l\'adresse mail que vous avez fournie, après examen de votre demande. Chaque demande étant traitée individuellement, il n\'est pas nécessaire de nous relancer par courrier.',
        ...
        'form.arrondissementLink.92': 'Cliquer ici pour consulter la liste des arrondissements de rattachement des communes des Hauts-de-Seine.',
        'form.arrondissementLink.94': 'Cliquer ici pour consulter la liste des arrondissements de rattachement des communes du Val-de-Marne.',
        'form.selectArrondissement': 'Sélectionnez votre arrondissement',
        'form.agdref': 'Numéro étranger',
        'form.agdrefFormat': 'Format attendu : 10 chiffres figurant sur votre titre',
        'form.statut': 'Statut',
        ...
        'form.commune.placeholder': 'Tapez le nom de votre commune ou votre code postal...',
        'form.commune.suggestions.label': 'Suggestions de communes',
        'form.commune.noResults': 'Aucune commune trouvée. Veuillez vérifier l\'orthographe.',
        'form.arrondissement.display': 'Arrondissement',
        'form.arrondissement.notMapped': 'Attention : Cette commune est rattachée à un arrondissement non pris en charge par ce formulaire.',
...
Cordialement,`,
    ...
    EN: {
        ...
        // Service title
        'service.title.': 'State Services',
        'service.title.78': 'State Services in Yvelines',
        'service.title.91': 'State Services in Essonne',
        'service.title.92': 'State Services in Hauts-de-Seine',
        'service.title.94': 'State Services in Val-de-Marne',
        'service.tagline.': 'State Portal',
        'service.tagline.78': 'Yvelines State Portal',
        'service.tagline.91': 'Essonne State Portal',
        'service.tagline.92': 'Hauts-de-Seine State Portal',
        'service.tagline.94': 'Val-de-Marne State Portal',
        'service.home.': 'Home - State Services',
        'service.home.78': 'Home - State Services in Yvelines',
        'service.home.91': 'Home - State Services in Essonne',
        'service.home.92': 'Home - State Services in Hauts-de-Seine',
        'service.home.94': 'Home - State Services in Val-de-Marne',
        ...
        // Footer
        'footer.home': 'DELPHES',
        'footer.description': 'Official portal of state services in the department',
        ...
        'accueil.intro.line1.78': 'You wish to contact the foreign reception services in the Yvelines department.',
        'accueil.intro.line1.91': 'You wish to contact the foreign reception services in the Essonne department.',
        'accueil.intro.line1.92': 'You wish to contact the foreign reception services in the Hauts-de-Seine department.',
        'accueil.intro.line1.94': 'You wish to contact the foreign reception services in the Val-de-Marne department.',
        ...
        'accueil.intro.aiProcessing.78': 'Your request is pre-processed by an artificial intelligence system that analyzes its content before transmission to an agent of the Migration Department of the Yvelines prefecture. If your situation falls under a procedure already available online on a public service, you will be automatically directed to this procedure. The prefecture will nevertheless be informed of your request to ensure follow-up.',
        'accueil.intro.aiProcessing.91': 'Your request is pre-processed by an artificial intelligence system that analyzes its content before transmission to an agent of the Migration Department of the Essonne prefecture. If your situation falls under a procedure already available online on a public service, you will be automatically directed to this procedure. The prefecture will nevertheless be informed of your request to ensure follow-up.',
        'accueil.intro.aiProcessing.92': 'Your request is pre-processed by an artificial intelligence system that analyzes its content before transmission to an agent of the Migration Department of the Hauts-de-Seine prefecture. If your situation falls under a procedure already available online on a public service, you will be automatically directed to this procedure. The prefecture will nevertheless be informed of your request to ensure follow-up.',
        'accueil.intro.aiProcessing.94': 'Your request is pre-processed by an artificial intelligence system that analyzes its content before transmission to an agent of the Migration Department of the Val-de-Marne prefecture. If your situation falls under a procedure already available online on a public service, you will be automatically directed to this procedure. The prefecture will nevertheless be informed of your request to ensure follow-up.',
        ...
        'accueil.alert.info.processingTime.78': 'Due to high demand, file processing requires some time. Please do not renew your request to avoid increasing the workload of agents.',
        'accueil.alert.info.processingTime.91': 'Due to high demand, file processing requires some time. Please do not renew your request to avoid increasing the workload of agents.',
        'accueil.alert.info.processingTime.92': 'Due to high demand, file processing requires some time. Please do not renew your request to avoid increasing the workload of agents.',
        'accueil.alert.info.processingTime.94': 'Due to high demand, file processing requires some time. Please do not renew your request to avoid increasing the workload of agents.',
        'accueil.alert.warning.78': 'Personal data collected through the contact form is not stored by the AI service.',
        'accueil.alert.warning.91': 'Personal data collected through the contact form is not stored by the AI service.',
        'accueil.alert.warning.92': 'Personal data collected through the contact form is not stored by the AI service.',
        'accueil.alert.warning.94': 'Personal data collected through the contact form is not stored by the AI service.',
        ...
        'analysis.form.cases': 'cases that may match your request.',
        'analysis.form.yourSelection': 'Please select the case that applies to your situation or go back to the form and rephrase your request.',
        ...
        'analysis.form.fields.numero_dossier_ANEF': 'ANEF file number',
        ...
        'analysis.backToHome': 'Back to form',
        ...
        'form.commune.placeholder': 'Type the name of your municipality or your postal code...',
        'form.commune.suggestions.label': 'Municipality suggestions',
        'form.commune.noResults': 'No municipality found. Please check the spelling.',
        'form.arrondissement.display': 'District',
        'form.arrondissement.notMapped': 'Warning: This municipality is attached to a district not supported by this form.',
