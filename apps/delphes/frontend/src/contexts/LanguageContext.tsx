...
const translations: Record<Language, Record<string, string>> = {
    FR: {
        ...
        'form.arrondissement': 'Veuillez sélectionner l\'arrondissement de rattachement de votre commune de résidence',
        ...
        'form.agdref': 'N° AGDREF',
        'form.agdrefFormat': 'Format attendu : 78123456789',
...
Cordialement,`,
    ...
    EN: {
        ...
        'form.arrondissement': 'Please select the district of your municipality of residence',
        ...
        'form.agdrefFormat': 'Expected format: 78123456789',
        'form.message': 'Message',
