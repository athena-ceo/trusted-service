...
const translations: Record<Language, Record<string, string>> = {
    FR: {
        ...
        'accueil.alert.info.message': 'Pour toute information concernant le suivi de votre demande de titre de séjour, indiquez impérativement votre numéro étranger/AGDREF (à 10 chiffres) figurant sur votre titresi vous en avez un.',
        ...
        'analysis.form.fields.numero_dossier_ANEF': 'Numéro de dossier ANEF',
