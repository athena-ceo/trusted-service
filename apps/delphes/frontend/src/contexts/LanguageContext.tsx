...
Cordialement,`,
    ...
    EN: {
        ...
        'accueil.alert.warning.78': 'Personal data collected through the contact form is not stored by the Yvelines prefecture.',
        'accueil.alert.warning.91': 'Personal data collected through the contact form is not stored by the Essonne prefecture.',
        'accueil.alert.warning.92': 'Personal data collected through the contact form is not stored by the Hauts-de-Seine prefecture.',
        'accueil.alert.warning.94': 'Personal data collected through the contact form is not stored by the Val-de-Marne prefecture.',
